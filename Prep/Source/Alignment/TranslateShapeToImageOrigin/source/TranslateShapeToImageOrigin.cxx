...
int main( int argc, char * argv[] )
{
    ...
    float centerX    = (float) options.get("centerX");
    float centerY    = (float) options.get("centerY");
    float centerZ    = (float) options.get("centerZ");
    ...
    /*write the transform parameters to a text file*/

    std::ofstream ofs;
    std::string fname=parameterFilename;
    ...
    ofs <<"inFilename:"<<inFilename<<"\n";
    ofs <<"outFilename:"<<outFilename<<"\n";
