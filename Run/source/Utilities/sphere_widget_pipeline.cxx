/*=========================================================================
  ...
  Module:    $RCSfile: sphere_widget_pipeline.cxx,v $
...
sphere_widget_pipeline::sphere_widget_pipeline()
{
  //  m_sphere_widget = vtkSphereWidget::New();
  m_sphere_source = vtkSphereSource::New();
  ...
  m_transformer->SetInput(m_sphere_source->GetOutput());
