...
class MyRegression2DMultiscaleIterationCommand : public itk::Command
{
public:
...
protected:
  MyRegression2DMultiscaleIterationCommand() {}
  ~MyRegression2DMultiscaleIterationCommand() {}
private:
  MyRegression2DMultiscaleIterationCommand(const Self &);        //purposely not implemented
...
int itkPSMEntropyRegressionModel2DFilterMultiscaleTest(int argc, char* argv[] )
{
  ...
  if (argc < 2)
	...
	<< "PSMEntropyRegressionModel2DFilterMultiscaleTest parameter_file [output_path]\n"
  ...
  try
    {
     ...
     itk::MyRegression2DMultiscaleIterationCommand::Pointer mycommand = itk::MyRegression2DMultiscaleIterationCommand::New();
